...
@media(max-width:340px){.tournament-experience-v2 .tx-step>span{font-size:.56rem}.tournament-experience-v2 .tx-team-carousel{grid-template-columns:38px minmax(0,1fr) 38px}.tournament-experience-v2 .tx-team-arrow{width:38px}.tx-cup-selector-v3 .tx-cup-locations button{flex-direction:column;gap:1px;padding:4px 2px}.tx-cup-selector-v3 .tx-cup-locations b{max-width:100%;font-size:.56rem;line-height:1;overflow-wrap:anywhere}.tx-cup-selector-v3 .tx-cup-main p{display:none}}
