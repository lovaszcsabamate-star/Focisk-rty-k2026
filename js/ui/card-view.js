/** Kártya DOM-jának előállítása a játékmenettől függetlenül. */

import {
  ATTRIBUTE_BY_KEY, CARD_ATTRIBUTE_KEYS, formatAttribute, hasAttributeData,
} from '../data/players.js';
import { ART, el, initials, tryArt } from './dom.js';

export class CardView {
  cardRows(card, activeAttributeKey) {
  ...
  renderCard(card, opts = {}) {
    ...
    for (const attribute of this.cardRows(card, opts.activeAttribute)) {
