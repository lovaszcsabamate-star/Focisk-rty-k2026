...
console.log(`✓ Height coverage audit: ${audit.summary.known}/${audit.summary.players} (${audit.summary.coveragePercent}%), hiányzó=${audit.summary.missing}, invalid=${audit.summary.invalid}`);
