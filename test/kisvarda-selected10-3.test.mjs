...
assertRegisteredDataFile('club-official-enrichment-9-kisvarda-selected10.json', 'enrichments');
assertRegisteredDataFile('club-official-stat-patches-kisvarda-selected10-3.json', 'statPatches');
