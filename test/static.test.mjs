...
assert.match(mobileExperienceJs, /services\/save-service\.js/);
...
assert.match(menuController, /Büntetőpárbaj/);
assert.doesNotMatch(menuController, /Penalties mód|Tizenegyes mód/);
