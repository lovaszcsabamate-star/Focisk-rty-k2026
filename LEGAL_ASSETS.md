...
## Jóváhagyott helyettesítő assetek
...
A helyettesítő klubjelvények belső státusza: `brandingStatus: "placeholder"`.

## Meglévő, további eredetigazolást igénylő elemek

| Asset | Fájl | Jelenlegi állapot | Kiadási szabály |
|---|---|---|---|
| Projektikon | `assets/icons/icon.svg` | eredeti forrás/generálási dokumentáció ellenőrzendő | kereskedelmi kiadás előtt igazolás szükséges |
| Apple touch ikon | `assets/icons/apple-touch-icon.png` | eredeti forrás/generálási dokumentáció ellenőrzendő | kereskedelmi kiadás előtt igazolás szükséges |
| Kocsmaháttér | `assets/pub/background.webp`, `.jpg`, `.png` | forrás, jogosult és felhasználási jog ellenőrzendő | jóváhagyásig a build nem ágyazza be; a CSS-háttér marad |
...
- A kezelőfelület jelenleg Unicode/emoji jeleket és CSS-ből rajzolt elemeket használ.
